...
private constructor() {
    ...
    private var mNumFramesFloat: Float = 0.toFloat()
    ...
    @Throws(java.io.FileNotFoundException::class, IOException::class, InvalidInputException::class)
    private fun ReadFile(inputFile: File) {
        ...
        mNumFramesFloat = numSamples.toFloat() / samplesPerFrame
        println(numSamples.toString() + "sstest" + samplesPerFrame + "--" + mNumFramesFloat)
